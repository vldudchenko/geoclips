 ...
 */
export const isValidVideoType = (mimeType, filename) => {
 ...
 */
export const isValidFileSize = (size, maxSize = constants.VIDEO_LIMITS.MAX_FILE_SIZE) => {
 ...
 */
export const isValidTextLength = (text, min, max) => {
 ...
 */
export const isValidYandexId = (id) => {
 ...
 */
export const validateVideoUpload = (videoData) => {
  const errors = {};
